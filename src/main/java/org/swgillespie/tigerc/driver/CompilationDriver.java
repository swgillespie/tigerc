...
public class CompilationDriver {
    public static AstNode runPipeline(CompilationSession session, String input) {
        ...
        CompilationPass<AstNode, AstNode> pass4 = new IRTransPass();
        ...
        node = pass4.runPass(session, node);
        return node;
    }
}
